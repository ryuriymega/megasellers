...
$size = 20;
imagettftext($image, $size, $angle1, 10, $size+15, $textColor1, $font, $letter1);
imagettftext($image, $size, $angle2, 35, $size+15, $textColor2, $font, $letter2);
imagettftext($image, $size, $angle3, 60, $size+15, $textColor3, $font, $letter3);
imagettftext($image, $size, $angle4, 85, $size+15, $textColor4, $font, $letter4);
imagettftext($image, $size, $angle5, 110, $size+15, $textColor5, $font, $letter5);
